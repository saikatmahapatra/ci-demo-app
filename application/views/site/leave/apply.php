...
<div class="row">
	<div class="col-lg-12">
		...
		<h6>Leave Balance</h6>
		<div class="row mb-3">
			<div class="col-lg-3">Casual Leave (CL) : <?php echo isset($leave_balance[0]['cl']) ? $leave_balance[0]['cl'] : '0.0'; ?></div>
			<div class="col-lg-3">Privileged Leave (PL) : <?php echo isset($leave_balance[0]['pl']) ? $leave_balance[0]['pl'] : '0.0'; ?></div>
			<div class="col-lg-3 d-none">Optional Leave (OL) : <?php echo isset($leave_balance[0]['ol']) ? $leave_balance[0]['ol'] : '0.0'; ?></div>			
		</div>
