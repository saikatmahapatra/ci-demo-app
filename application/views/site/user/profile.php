								...
								<div class="row mt-3">
									<div class="col-md-12">
										...
										<dl class="row">
											...
											<dt class="col-md-2">Customer ID</dt>
											...
											<div class="user-profile-section">
												<div class="section-heading">
													...
													<?php if($is_self_account == true) { ?>
														...
														<a href="<?php echo base_url($this->router->directory.$this->router->class.'/delete_address/'.$addr["id"]);?>" class="btn-action"><i class="fa fa-fw fa-trash-o" aria-hidden="true"></i> Delete</a>
													<?php } ?>
												</div>
												<div>
										...
										<?php if(isset($education)){
											...
											<div class="user-profile-section">
												...
												<?php if($is_self_account == true) { ?>
													...
													<a href="<?php echo base_url($this->router->directory.$this->router->class.'/delete_education/'.$edu["id"]);?>" class="btn-action" data-toggle="tooltip" title="Delete"><i class="fa fa-fw  fa-trash-o" aria-hidden="true"></i> Delete</a>
													<?php } ?>
												</div>
												<div>
