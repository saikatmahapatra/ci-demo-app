...
<div class="row">
  ...
  <div class="media-body">
    ...
    <div>
        ...
        <a href="<?php echo base_url('user/edit_profile');?>">Edit</a>
    </div>
	<hr>
    <!--<hr style="m-8 auto">
...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active" id="nav-basic" role="tabpanel" aria-labelledby="nav-basic-tab">
	<div class="row mt-3">
		<div class="col-md-12">
        <a class="btn btn-info btn-sm" href="<?php echo base_url('user/edit_profile');?>"><i class="fa fa-edit" aria-hidden="true"></i> Edit</a>
        <!--<h6>Basic Info</h6><hr>-->
        <div class="row">
  ...
  <div class="tab-pane fade" id="nav-address" role="tabpanel" aria-labelledby="nav-address-tab">
	<div class="row mt-3">
		<div class="col-md-12">
		<a class="btn btn-success btn-sm" href="<?php echo base_url('user/add_address');?>"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add New</a>
				...
				<?php if(isset($address)){
					...
					?>
						<div class="row mb-3">
							...
							<div class="col-md-2">			
								<a href="<?php echo base_url('user/edit_address/'.$addr["id"]);?>" class="btn btn-outline-secondary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></a>
								<a href="<?php echo base_url('user/delete_address/'.$addr["id"]);?>" class="btn btn-outline-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i></a>
							</div>
						</div>
						<!--/.row-->
					<?php
  ...
  <div class="tab-pane fade" id="nav-education" role="tabpanel" aria-labelledby="nav-education-tab">
	<div class="row mt-3">
		<div class="col-md-12">
			<a class="btn btn-success btn-sm" href="<?php echo base_url('user/add_education');?>"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add New</a>
					...
					<?php if(isset($education)){
						...
						?>
							<tr>
								...
								<td>
									<a href="<?php echo base_url('user/edit_education/'.$edu["id"]);?>" class="btn btn-outline-secondary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></a>
									<a href="<?php echo base_url('user/delete_education/'.$edu["id"]);?>" class="btn btn-outline-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i></a>
								</td>
