<div class="row">
    <div class="col-md-12">
        <h1 class="page-header">CI Form Helper</h1>               
    </div>
</div><!--/.row-->
...
<div class="row">
    <div class="col-md-6">        
        ...
        <div class="form-group">            
			<label for="address" class="">Address <span class="star">*</span></label>
            <?php
        ...
        <div class="form-group">            
			<label for="job_role" class="">Job Role <span class="star">*</span></label>
            <?php
        ...
        <div class="form-group">                    
			<label for="functional_domain" class="">Job Domain <span class="star">*</span></label>
            <?php
        ...
        <div class="form-group">
			<label for="functional_domain" class="">Resume <span class="star">*</span></label>
            <?php
...
<!-- T&C Modal -->
<div class="modal fade" id="tncModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Google Terms of Service</h4>
      </div>
