	...
	<div class="col-md-9">
		...
		<div class="form-row">
			<div class="form-group col-md-4">
				<label for="banner_type" class="">Content Type <span class="required">*</span></label>
				<?php echo form_dropdown('banner_type', $arr_content_type, (isset($_POST['banner_type']) ? set_value('banner_type') : $row['banner_type']), array('class' => 'form-control',));?>
