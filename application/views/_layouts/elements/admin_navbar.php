...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top colorgraph-navbar">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown_1">
                        <a class="dropdown-item" href="<?php echo base_url($this->router->directory.'shop/manage_orders'); ?>">Order Management</a>
            ...
            <ul class="navbar-nav my-2 my-lg-0">
                ...
                <div class="nav-item dropdown no-toggle-icon">
                    ...
                    <ul class="notification dropdown-menu dropdown-menu-right">
                        <li class="notification-title">You have 0 new notifications.</li>
                            <!-- <div class="notification-content">
                                <li><a class="notification-item" href="<?php echo base_url();?>"><span class="notification-icon"><span class="fa-stack "><i class="fa fa-fw fa-bookmark-o-o fa-stack-2x text-primary"></i><i class="fa fa-fw fa-envelope"></i></span></span><div><p class="notification-message">Lisa sent you a mail</p><p class="notification-meta">2 min ago</p></div></a></li>
                                <li><a class="notification-item" href="<?php echo base_url();?>"><span class="notification-icon"><span class="fa-stack "><i class="fa fa-fw fa-bookmark-o-o fa-stack-2x text-danger"></i><i class="fa fa-fw fa-hdd-o "></i></span></span><div><p class="notification-message">Mail server not working</p><p class="notification-meta">5 min ago</p></div></a></li>
                                <li><a class="notification-item" href="<?php echo base_url();?>"><span class="notification-icon"><span class="fa-stack "><i class="fa fa-fw fa-bookmark-o-o fa-stack-2x text-success"></i><i class="fa fa-fw fa-money "></i></span></span><div><p class="notification-message">Transaction complete</p><p class="notification-meta">2 days ago</p></div></a></li>
                                <div
