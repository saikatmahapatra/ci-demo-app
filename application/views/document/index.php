			...
			<div class="card-body">
				...
				<div class="file-container row my-3" id="upload_grid_<?php echo $upload['id']; ?>">
					...
					<div class="col-md-4">
						...
						?>
						<a href="<?php echo $file_src;?>" title="<?php echo $upload['upload_document_type_name'];?>" data-file-name="<?php echo $upload['upload_file_name']; ?>" class="btn btn-sm btn-outline-secondary <?php echo $btn_class;?>" target="_new"><i class="fa fa-download"></i> View/Download</a>
