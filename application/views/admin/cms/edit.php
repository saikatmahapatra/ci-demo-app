						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<?php echo form_input(array('name' => 'pagecontent_title', 'value' => (isset($_POST['pagecontent_title']) ? set_value('pagecontent_title') : $row['pagecontent_title']), 'id' => 'pagecontent_title', 'class' => 'form-control', 'placeholder' => '', 'title' => '','minlength' => '','maxlength' => '', ));?>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<?php echo form_textarea(array('name' => 'pagecontent_text','value' => (isset($_POST['pagecontent_text']) ? set_value('pagecontent_text') : $row['pagecontent_text']),'class' => 'form-control textarea','id' => 'pagecontent_text','rows' => '4','cols' => '50','placeholder' => '','title' => '','minlength' => '','maxlength' => '', 'style'=>'width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;' )); ?>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<?php echo form_input(array('name' => 'pagecontent_meta_keywords','value' => (isset($_POST['pagecontent_meta_keywords']) ? set_value('pagecontent_meta_keywords') : $row['pagecontent_meta_keywords']),'id' => 'pagecontent_meta_keywords','class' => 'form-control','rows' => '4','cols' => '50','placeholder' => '', 'title' => '','minlength' => '','maxlength' => '',)); ?>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<?php echo form_input(array('name' => 'pagecontent_meta_description','value' => (isset($_POST['pagecontent_meta_description']) ? set_value('pagecontent_meta_description') : $row['pagecontent_meta_description']),'id' => 'pagecontent_meta_description','class' => 'form-control','rows' => '4','cols' => '50','placeholder' => '','title' => '', 'minlength' => '10','maxlength' => '200',));?>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<?php echo form_input(array('name' => 'pagecontent_meta_author','value' => (isset($_POST['pagecontent_meta_author']) ? set_value('pagecontent_meta_author') : $row['pagecontent_meta_author']),'class' => 'form-control','id' => 'pagecontent_meta_author','placeholder' => '','title' => '',));?>
