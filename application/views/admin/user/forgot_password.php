...
<div class="card card-login mx-auto mt-5">
  ...
  <div class="card-body">
	...
	<div class="form-label-group">		
		<?php echo form_input(array('name' => 'user_email','value' => set_value('user_email'),'id' => 'user_email','class'=> 'form-control','placeholder' => 'Registered Email','maxlength' => '100','autofocus' => true,));?>
