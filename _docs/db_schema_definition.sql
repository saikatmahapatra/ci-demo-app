...
CREATE TABLE IF NOT EXISTS `ticket_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ticket_type_name` varchar(250) DEFAULT NULL,
  `ticket_type_parent` int(11) DEFAULT NULL,   
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `ticket_status` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ticket_status_name` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tickets` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ticket_reference_number` varchar(128) DEFAULT NULL,
  `ticket_type_id` varchar(100) DEFAULT NULL,
  `ticket_status_id` varchar(100) DEFAULT NULL,
  `ticket_title` text DEFAULT NULL,
  `ticket_description` text DEFAULT NULL,
  `ticket_created_by` int(11) DEFAULT NULL,
  `ticket_created_by_name` varchar(100) DEFAULT NULL,
  `ticket_created_by_email` varchar(254) DEFAULT NULL,
  `ticket_created_by_phone` varchar(15) DEFAULT NULL,
  `ticket_created_by_address` varchar(150) DEFAULT NULL,   
  `ticket_create_date` datetime DEFAULT CURRENT_TIMESTAMP,  
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `ticket_activity` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ticket_id` id(11) DEFAULT NULL,  
  `ticket_history_date` datetime DEFAULT CURRENT_TIMESTAMP,  
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `newsletter_subscribers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `newsletter_subscriber_email` varchar(254) NOT NULL,
  `newsletter_subscriber_active` enum('Y','N') NOT NULL DEFAULT 'Y',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `newsletter_groups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `newsletter_group_name` varchar(100) NOT NULL,
  `newsletter_group_is_active` enum('Y','N') NOT NULL DEFAULT 'Y',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1;
